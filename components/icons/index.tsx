...
/**
 * Every path below is copied verbatim from the contest-supplied SVG pack
 * (asset_package.zip / SVGs/*.svg) — only the hardcoded #000000 fill/stroke
 * was swapped for currentColor so the existing color utilities work. No
 * external icon library is used; geometry is untouched.
 */
...
/** arrow-path.svg — self-healing / auto-sync */
...
/** arrow-trending-up.svg — growth / stats */
export function IconArrowTrendingUp(props: IconProps) {
  return (
    <svg {...outline} {...props}>
...
/** chart-pie.svg — analytics / governance */
export function IconChartPie(props: IconProps) {
  return (
    <svg {...outline} {...props} fill="none">
      <g>
...
/** chevron-down.svg — accordion expand / scroll hint */
...
/** chevron-left.svg — pagination previous */
...
/** chevron-right.svg — pagination next / CTA */
...
/** chevron-up-solid.svg — back to top */
export function IconChevronUpSolid(props: IconProps) {
  return (
    <svg {...solid} {...props}>
      <path
        fillRule="evenodd"
...
/** chevron-up.svg — static sort/recency indicator */
...
/** cog-8-tooth.svg — orchestration / settings / policy */
...
/** cube-16-solid.svg — data / sources */
export function IconCube(props: IconProps) {
  return (
    <svg {...solid} {...props} viewBox="0 0 16 16">
...
/** link-solid.svg — lineage / composable connections */
export function IconLinkSolid(props: IconProps) {
  return (
    <svg {...solid} {...props}>
      <path
        fillRule="evenodd"
...
/** link.svg — pipeline routes / source connections */
